...
const ExtractInputSchema = z.object({
    instruction: z.string().describe(`The specific instruction for what information to extract from the current page.
...
async function handleExtract(context, params) {
    const action = async () => {
        try {

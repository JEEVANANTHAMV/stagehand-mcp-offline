...
export const configSchema = z
    ...
    modelBaseURL: z
        .string()
        .optional()
        .describe("Base URL for the model provider (for custom OpenAI-compatible endpoints). Useful for self-hosted LLMs like Ollama, LM Studio, or custom APIs. Example: http://localhost:11434/v1"),
    experimental: z
        .boolean()
        .optional()

...
export const screenshots = new Map();
...
const sessionIdToScreenshotNames = new Map();
export function registerScreenshot(sessionId, name, base64) {
...
export function clearScreenshotsForSession(sessionId) {
